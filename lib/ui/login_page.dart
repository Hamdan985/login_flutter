...
//                      showInSnackBar("Login button pressed");
                      ...
                      final Map loginInput = {
                        'email': loginEmailController.text,
                        'password': loginPasswordController.text
                      };
                      loginValidation(loginInput);
...
//                      print(confirmPassword);
  ...
  void loginValidation(Map loginInput) {
    print(loginInput);
    if (loginInput['email'] == '') {
      showInSnackBar('Email is required');
    } else if (loginInput['password'] == '') {
      showInSnackBar('Password is required');
    }
  }

  void registerValidation(Map userInput) {
    print(userInput);
    if (userInput['name'] == '') {
      showInSnackBar('Name is required');
      ...
      showInSnackBar('Password don\'t Match');
    }
  }
